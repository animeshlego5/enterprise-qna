    ...
    <main className="flex min-h-screen flex-col items-center bg-claude-bg px-4 py-20">
      ...
      <div className="mb-12 flex flex-col items-center gap-4 text-center">
        ...
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-claude-accent/15 ring-1 ring-claude-accent/30">
          ...
          >
            <path
              d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 3a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm-1 4h2v8h-2V9z"
              fill="currentColor"
              opacity="0.4"
            />
            <path
              d="M8.5 8.5C9.5 7 10.7 6 12 6c1.5 0 2.8 1 3.7 2.5M7 12c0-2.8 2.2-5 5-5s5 2.2 5 5-2.2 5-5 5c-1.8 0-3.4-1-4.3-2.5"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
            />
        ...
        <div>
          <h1 className="text-3xl font-semibold tracking-tight text-claude-text">
            Enterprise QnA
          </h1>
          <p className="mt-2 max-w-md text-base leading-relaxed text-claude-muted">
            Ask questions answered from your knowledge base, powered by RAG + semantic cache.
          </p>
        </div>
      </div>
      ...
      <div className="mt-12 flex items-center gap-3 text-sm text-claude-subtle">
        ...
        <a
          href="https://github.com/animeshlego5/enterprise-qna"
          target="_blank"
          rel="noopener noreferrer"
